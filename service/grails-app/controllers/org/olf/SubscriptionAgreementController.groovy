        ...
        switch ( content_item.type ) {
          case 'package':
            ...
            if ( pkg != null ) {
              ...
              Entitlement ent = new Entitlement(eResource:pkg, owner:sa, enabled:Boolean.TRUE).save(flush:true, failOnError:true);
          ...
          case 'packageItem':
            ...
            if ( pci != null ) {
              ...
              Entitlement ent = new Entitlement(eResource:pci, owner:sa, enabled:Boolean.TRUE).save(flush:true, failOnError:true);
          ...
          case 'platformTitle':
            ...
            if ( pti != null ) {
              ...
              Entitlement ent = new Entitlement(eResource:pti, owner:sa, enabled:Boolean.TRUE).save(flush:true, failOnError:true);
