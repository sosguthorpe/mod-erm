...
java -jar build/libs/olf-erm-1.0.jar -Xmx1G --grails.server.host=10.0.2.2 --okapi.service.host=localhost --okapi.service.port=9130 --dataSource.username=folio_admin --dataSource.password=folio_admin --dataSource.url=jdbc:postgresql://localhost:54321/okapi_modules
